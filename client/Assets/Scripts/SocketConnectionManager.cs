...
public class SocketConnectionManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            this.players[positionUpdate.player_id].transform.position = new Vector3(positionUpdate.x - 50.0f, this.players[positionUpdate.player_id].transform.position.y, positionUpdate.y + 50.0f);
        }
    }
