        ...
        if (instance == null)
        {
            ...
            user = new User
            {
                ...
                units = new List<Unit>
                {
                    ...
                    new Unit { id = "6", tier = 0, level = 1, character = characters.Find(character => "muflus" == character.name.ToLower()), slot = null, selected = false, rank = Rank.Ilumination1 },
                    new Unit { id = "7", tier = 0, level = 3, character = characters.Find(character => "kenzu" == character.name.ToLower()), slot = null, selected = false, rank = Rank.Ilumination2 },
                    new Unit { id = "8", tier = 0, level = 2, character = characters.Find(character => "valtimer" == character.name.ToLower()), slot = null, selected = false, rank = Rank.Ilumination3 },
