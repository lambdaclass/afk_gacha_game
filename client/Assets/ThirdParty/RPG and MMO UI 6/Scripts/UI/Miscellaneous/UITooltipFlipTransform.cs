        ...
        public void OnAnchor(UITooltip.Anchor anchor)
        {
            ...
            switch (anchor)
            {
                ...
                case UITooltip.Anchor.TopRight:
                    ...
                    this.m_Transform.anchoredPosition = new Vector2(this.m_OriginalPosition.x * -1, this.m_OriginalPosition.y);
                    break;
                case UITooltip.Anchor.Top:
                    ...
                    this.m_Transform.anchoredPosition = new Vector2(this.m_OriginalPosition.x, this.m_OriginalPosition.y * -1);
                    break;
            }
        }
    }
