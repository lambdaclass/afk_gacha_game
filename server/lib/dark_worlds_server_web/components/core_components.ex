defmodule DarkWorldsServerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DarkWorldsServerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DarkWorldsServerWeb.Gettext, "errors", msg, opts)
    end
  end
